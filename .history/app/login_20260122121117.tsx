...
// The EXACT redirect URI for Expo proxy - must match Google Console
const REDIRECT_URI = `https://auth.expo.io/@${EXPO_PROJECT.owner}/${EXPO_PROJECT.slug}`;
...
export default function LoginScreen() {
  ...
  const [request, response, promptAsync] = Google.useAuthRequest({
    ...
    iosClientId: GOOGLE_CLIENT_IDS.web, // Use web client for Expo Go
    androidClientId: GOOGLE_CLIENT_IDS.web, // Use web client for Expo Go
    scopes: ['openid', 'profile', 'email'],
    redirectUri: REDIRECT_URI, // FORCE the Expo proxy URI
  });
  ...
  const handleGoogleLogin = async () => {
    ...
    console.log('Starting Google OAuth with proxy...');
    ...
    try {
      // CRITICAL: useProxy MUST be true for Expo Go
