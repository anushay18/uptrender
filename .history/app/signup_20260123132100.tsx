            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[
                styles.inputContainer,
                {
                  ...
                  console.log('[Signup] Auth request object:', request);

                  // useProxy only when running inside Expo Go / dev client
                  const result = await promptAsync({ useProxy: googleConfig.isExpoGo });
                  console.log('[Signup] OAuth raw result:', result);
                  console.log('[Signup] OAuth result type:', result.type);
                  try { console.log('[Signup] OAuth result details:', JSON.stringify(result, null, 2)); } catch(e) {}
